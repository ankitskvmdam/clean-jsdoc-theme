 ...
 * typedefs, and cross-references) and the theme's authoring components, all
 * written directly in this doc comment.
 *
 * > [!INFO]
 * > Everything below — this callout, the stepper, and the tabs — is authored
 * > inline in the `@module` doc comment. The same `[!NOTE]` / `[!TIP]` /
 * > `[!WARNING]` / `[!CAUTION]` markers work too.
 *
 * ## Quick start
 *
 * <steps>
